...
Status: proposed scenarios only. No evaluation execution is authorized or claimed.
...
| DS-16 | How long did pinnacle-Slc's Sev-1/2 alerts take to be acknowledged in June? | Alert severity, start and acknowledgement timestamps; M15. | Report P90 acknowledgement duration with valid-duration exclusions. Do not describe it as mean response time or incident resolution time. No target breach is presumed. |
